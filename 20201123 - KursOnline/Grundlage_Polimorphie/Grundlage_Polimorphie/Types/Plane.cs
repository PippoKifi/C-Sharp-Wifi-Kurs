namespace Console.WriteLine.Types
{
    class Plane : Vehicle
    {
        ...
        public Plane(string model, string descrition, int maxSpeed, int gewicht, int seats, Plane_Drives driveTechnology, int numberOfEngines, Plane_Producer producer)
            : base(model, descrition, maxSpeed, gewicht, seats)
        {
            _driveTechnology = driveTechnology;
